#ifndef H_BASEANIMATINGOVERLAY_CBASENPC_
#define H_BASEANIMATINGOVERLAY_CBASENPC_
...
public:
	...
	// Debug function inside sdk2013 useless
	...
	// Members
private:
	DECLAREVAR(CUtlVector<CAnimationLayer>, m_AnimOverlay);
private:
